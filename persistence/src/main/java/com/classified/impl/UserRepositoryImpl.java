...
import com.classified.exception.business.ResourceRemovedException;
import com.classified.exception.technical.DatabaseException;
    ...
    public void delete(User user) {
        execute("delete",
                em -> {
                    ...
                    curUser.setPassword("deleted_" + user.getId());
