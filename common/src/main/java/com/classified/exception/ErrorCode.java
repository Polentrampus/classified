...
public enum ErrorCode {
    ...
    FAILED_TO_MAP_ENTITY(HttpStatus.BAD_REQUEST,"FAILED_TO_MAP_ENTITY", "failed to map entity"),
    SECURITY_ERROR(HttpStatus.FORBIDDEN, "NOT_ENOUGH_RIGHTS", "Not enough rights"),
    ...
    EXTERNAL_SERVICE_ERROR(HttpStatus.SERVICE_UNAVAILABLE, "EXTERNAL_SERVICE_ERROR", "External service is unavailable");
